...
HD_PWD='D:/Projects/single_cycle_cpu/single_cycle_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_memory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_memory.tcl -notrace
